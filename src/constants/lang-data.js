const langData = {
  ...
  zh_CN: {
    ...
    team: '团队',
    language: 'En',
    a_collection_of: '本系列共计',
    kooks: '个头像',
    main_intro: '我们一直在寻找同类<br />和我们一起创造zui特别的元宇宙',
    who_is_kook: '谁是Kook',
    who_is_kook_intro: `我看起来社恐但是我擅长协作,<br />
    我有点夜盲但是我可以看到你们看不到的东西,<br />
    我比较敏感那是因为我是一只变种大猫,<br />
    我看起来很胆小是因为我可以预测到灾难,<br />
    我数学不好但是打赌总是会赢,<br />
    我很内向但其实我可以和动物交流,<br />
    我看起来特别普通但我其实是个被遗忘在地球的外星人，<br />
    …<br />
    我是个怪人是因为我真的与众不同。<br />
